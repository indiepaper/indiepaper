defmodule IndiePaperWeb.ModalComponent do
  ...
  def render(assigns) do
    ...
    <div
      ...
      phx-target={@myself}
      phx-page-loading>
      <div class="bg-white w-full md:w-auto max-h-4/5 md:max-h-3/4 md:inline-block rounded-t-xl md:rounded-xl overflow-y-auto overflow-y-contain max-w-6xl relative">
