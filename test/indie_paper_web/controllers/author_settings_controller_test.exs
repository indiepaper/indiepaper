defmodule IndiePaperWeb.AuthorSettingsControllerTest do
  ...
  describe "PUT /authors/settings (change email form)" do
    ...
    test "updates the author email", %{conn: conn, author: author} do
      ...
      assert Authors.get_author_by_email(author.email)
    end
  ...
  describe "GET /authors/settings/confirm_email/:token" do
    ...
    test "updates the author email once", %{
      ...
      refute Authors.get_author_by_email(author.email)
      assert Authors.get_author_by_email(email)
