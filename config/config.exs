...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js js/draft-editor.js js/book-description-editor.js js/book-reader.js js/simple-tip-tap-html-editor.js fonts/fonts.css --chunk-names=chunks/[name]-[hash] --splitting --format=esm --bundle --target=es2017 --minify --outdir=../priv/static/assets  --external:/fonts/* --external:/images/*),
