...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js js/draft-editor.js js/book-long-description-html-editor.js js/chapter-render.js static/fonts/fonts.css --bundle --loader:.otf=file --target=es2016 --outdir=../priv/static/assets),
