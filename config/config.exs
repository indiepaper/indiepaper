...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js js/draft-editor.js js/book-description-editor.js js/chapter-render.js js/simple-tip-tap-html-editor.js fonts/fonts.css --chunk-names=chunks/[name]-[hash] --splitting --format=esm --bundle --loader:.otf=file --target=es2017 --outdir=../priv/static/assets),
